...
const char *host_cochera = "http://154.56.51.172:8000/api/park/";

String str_host_cochera = "http://154.56.51.172:8000/api/park/";

const char *host_sensor = "http://154.56.51.172:8000/api/sensor?ip=192.168.1.103";

String str_host_sensor = "http://154.56.51.172:8000/api/sensor?ip=192.168.1.103";
...
//-------------------------------------CONECXION INTERNET-------------------------------------------------
const char* ssid="MovistarFibra-51D646";
const char* password = "morovalentino08";
...
//--------------------------------------------------------------------------------------------------------
void setup () {
  String getData, link1;
  link1 = str_host_sensor;  
...
//--------------------------------------------------------------------------------------------------------
  ...
  int httpCode = http.GET();
    ...
    if (httpCode > 0){
      ...
      String json_cochera = resp["cochera"];
      String json_reservado = resp["reservado"];
